    ...
    <div class="h-screen items-center justify-center flex">
        <div class="bg-gray-50" id="contact">
            ...
            <div
                ...
                <div>
                    <h2 class="text-2xl font-bold text-black">Contact Us</h2>
                    <p class="max-w-sm mt-4 mb-4 dark:text-gray-400">Have something to say? We are here to help. Fill up
                        the
                ...
                <div>
                    <form>
                        ...
                        <div class="mb-5">
                            <input id="name" type="text" placeholder="Name" autocomplete="false"
                                class="w-full px-4 py-3 border-2 placeholder:text-gray-800 rounded-md outline-none dark:placeholder:text-gray-300   focus:ring-4  border-gray-800 focus:border-gray-400 ring-gray-100 "
                                name="name">
                        </div>
                        <div class="mb-5">
                        ...
                        <button type="submit"
                            class="w-full py-4 font-semibold text-white transition-colors bg-gray-600 rounded-md hover:bg-gray-500 focus focus:ring-offset-2 focus:ring focus:ring-gray-200 px-7 ">Send
                            Message
                        </button>
                    </form>
                </div>
